...
/////////////////////////////////////////////////////////////////
//for interruption table - IDT - The Interrupt Descriptor Table//
/////////////////////////////////////////////////////////////////
struct idt_entry
{
...
/////////////////////////////////////////////////////
//for exeptions - ISRs - Interrupt Service Routines//
/////////////////////////////////////////////////////
struct regs
{
...
void fault_handler(struct regs *r)
{
    if (r->int_no < 32)
    {
        ...
        print_line(12,36,0,2,exception_messages[r->int_no]);
        for (;;);
    }
}
...
//////////////////////////////////////////////
//for devices - IRQs - Interrupt Requests or// 
//////////////////////////////////////////////
extern void irq0();
extern void irq1();
extern void irq2();
...
void irq_install_handler(int irq, int (*handler)(struct regs *r))
{
    irq_routines[irq] = (int)handler;
}
 ...
 //    char hello[] = "hello world!";
    ...
    *  set, that means that a key has just been released */
    if (scancode & 0x80)
    {
    	clear_terminal(0);
    	char hello[] = "hello world!";
    	print_line(12,36,0,2,&kbdus[scancode]);
...
{
    // void test(void *r);
    // irq_install_handler(1, (void *) &test);
